    ...
    <div>
      ...
      >
        <div>
          ...
          <button className="rounded-2xl bg-blue-700 px-4 py-2 text-white">Start free trial</button>
        </div>
        <img
      ...
      <div style={{ backgroundColor: 'rgb(146 151 179 / 13%)' }} className="mt-8 rounded-2xl">
