    ...
    <div className="max-w-full py-8 text-black">
      ...
      <section className="mb-16 bg-white px-3 py-8 md:px-8">
        ...
        <ul className="mt-4 list-disc pl-6">
          <li className="mb-4">Support of the active route (styled by default).</li>
          <li className="mb-4">Fully customizable and without external dependencies.</li>
          <li className="mb-4">
            No vendor lock-in, you can export it and integrate it in your project.
          </li>
          <li>Sidebar can be aligned left or right according to your preferences (on mobile).</li>
        </ul>
      </section>
      ...
      <section className="mb-16 bg-white px-3 py-8 md:px-8">
        ...
        <div className="mb-8 mt-4">
          ...
          <div className="mt-4 flex flex-wrap pl-6 md:flex-nowrap">
            ...
            <p className="pl-1">
              Icons used for each sidebar-item. You don't need this folder if you can provide your
              own icons.
            </p>
          </div>
          <div className="mt-6 flex flex-wrap pl-6 md:flex-nowrap">
            ...
            <p className="pl-1">
              It's in this file that you will add routes for each sidebar-item. it is an array of
              objects.
            </p>
          </div>
          ...
          <div className="mt-6 flex flex-wrap pl-6 md:flex-nowrap">
            ...
            <p className="pl-1">
              compose <strong>SidebarHeader</strong> and <strong>SidebarItems</strong> components.
            </p>
          </div>
          <div className="mt-6 flex flex-wrap pl-6 md:flex-nowrap">
            <JSXIcon /> <span className="px-2 font-medium">SidebarHeader.tsx</span> :
            <p className="pl-1">contains the logo displayed on top of the sidebar</p>
          </div>
          <div className="mt-6 flex flex-wrap pl-6 md:flex-nowrap">
            <JSXIcon /> <span className="px-2 font-medium">SidebarItems.tsx</span> :
            <p className="pl-1">
              automatically generates each sidebar-item according to your routes defined in
        ...
        <div>
          <div className="mt-8 flex flex-wrap md:flex-nowrap">
            <JSXIcon /> <span className="px-1 font-medium">Layout.tsx :</span> contains the
        ...
        <div>
          <div className="mt-8 flex flex-wrap md:flex-nowrap">
            <JSXIcon /> <span className="px-1 font-medium">Overlay.tsx :</span> displays an overlay
            that will only be visible on small screens to emphasize the focus on sidebar when it is
            open. it's also used to close sidebar on click outside
          </div>
        </div>

        <div>
          <div className="mt-8 flex flex-wrap md:flex-nowrap">
            <JSXIcon /> <span className="px-1 font-medium">Provider.tsx :</span> contains the{' '}
            <strong className="px-1">DashboardProvider</strong> component where all the dashboard
            logic is placed. this will then be reused in other components. it handles opening and
        ...
        <div>
          <div className="mt-8 flex flex-wrap md:flex-nowrap">
            ...
            You can customize it or replace it with your own TopBar but don't forget to add a button
            to toggle sidebar on mobile
          </div>
        </div>
        ...
        <div className="mt-8 flex flex-wrap md:flex-nowrap">
          ...
          <p className="pl-1">
            This style sheet is used to make the scrollbar invisible for the sidebar and to apply
            some filters.
          </p>
        </div>
      </section>
      ...
      <section className="mb-16 bg-white px-3 py-8 md:px-8">
        ...
        <p className="mt-5">
          The sidebar scrollbar is hidden by default but you can still scroll with the keyboards if
          you have several sidebar-items. You can always change its style in the
        ...
        <p className="mt-5">
          ...
          <strong className="pl-1">mobileOrientation</strong>, which indicates the orientation of
          the sidebar on small devices (viewport {'<'} 1024px).
        </p>
