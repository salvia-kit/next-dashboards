  ...
  return (
    <div className="flex flex-col flex-wrap sm:flex-row">
      <div className="mb-6 w-full pr-2 md:w-4/12">
        <div className="rounded-2xl bg-white p-4 shadow">
          <div className="flex items-center">
            ...
            <p className="text-base ml-2 text-black">{title || 'Total Gains'}</p>
          </div>
      ...
      <div className="relative mt-8 w-full overflow-hidden rounded-xl bg-white p-4 shadow-lg md:mr-2 md:w-3/12">
        <p className="mb-6 text-xl font-light text-gray-600">Popular Investors</p>
        <div className="grid grid-cols-3 gap-4">
          ...
          <div className="flex flex-col items-center">
            ...
            <span className="mt-2 text-xs text-gray-600">Cristiano Ronaldo</span>
          </div>
          <div className="flex flex-col items-center">
            <div className="relative">
              <a href="#" className="relative block">
      ...
      <div className="relative mt-8 w-full overflow-hidden rounded-xl bg-white p-4 text-gray-700 shadow-lg md:ml-2 md:w-4/12">
        <a href="#" className="block h-full w-full">
          <div className="w-full">
            <p className="mb-4 text-2xl font-light text-gray-700">Task Progress</p>
