        ...
        <div className="mx-auto max-w-lg overflow-hidden rounded-lg shadow lg:flex lg:max-w-none">
          <div className="bg-white px-6 py-8 lg:p-12">
            ...
            <p className="mt-6 text-base leading-6 text-gray-500">
              Start selling online for free with all the features you need to launch your local
              delivery and pick-up service, nothing more. We don&#x27;t charge commission or monthly
            ...
            <div className="mt-8">
              ...
              <ul className="mt-8 lg:grid lg:grid-cols-2">
                <li className="flex items-start lg:col-span-1">
                  ...
                  <p className="ml-3 text-sm leading-5 text-gray-700">All unlimited components</p>
                </li>
                <li className="flex items-start lg:col-span-1">
                  <div className="shrink-0">
                    <svg
                  ...
                  <p className="ml-3 text-sm leading-5 text-gray-700">Own custom Tailwind styles</p>
                </li>
                <li className="flex items-start lg:col-span-1">
                  <div className="shrink-0">
                    <svg
                  ...
                  <p className="ml-3 text-sm leading-5 text-gray-700">Unlimited Templates</p>
                </li>
                <li className="flex items-start lg:col-span-1">
                  <div className="shrink-0">
                    <svg
                  ...
                  <p className="ml-3 text-sm leading-5 text-gray-700">Free premium dashboard</p>
                </li>
                <li className="flex items-start lg:col-span-1">
                  <div className="shrink-0">
                    <svg
                  ...
                  <p className="ml-3 text-sm leading-5 text-gray-700">Best ranking</p>
                </li>
                <li className="flex items-start lg:col-span-1">
                  <div className="shrink-0">
                    <svg
                  ...
                  <p className="ml-3 text-sm leading-5 text-gray-700">Premium svg</p>
                </li>
                <li className="flex items-start lg:col-span-1">
                  <div className="shrink-0">
                    <svg
                  ...
                  <p className="ml-3 text-sm leading-5 text-gray-700">My wife</p>
                </li>
              </ul>
            </div>
            <div className="mt-8">
          ...
          <div className="bg-white px-6 py-8 text-center lg:flex lg:shrink-0 lg:flex-col lg:justify-center lg:p-12">
            ...
            <p className="mt-4 text-sm leading-5">
              <span className="block font-medium text-gray-500">Card payments:</span>
